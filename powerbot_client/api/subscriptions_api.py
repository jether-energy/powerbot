...
class SubscriptionsApi:
    ...
    def get_subscription_endpoints(
        ...
        _param = self._get_subscription_endpoints_serialize(
    ...
    @validate_call
    def get_subscription_endpoints_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SubscriptionEndpoint]]:
        """List websocket endpoints
    ...
    @validate_call
    def get_subscription_endpoints_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_subscription_endpoints_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
