...
class SettingsApi:
    ...
    def get_ip_allowlist_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[IPAllowlistEntry]]:
        """Get current IP allowlist
    ...
    def _get_ip_allowlist_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/settings/ip-allowlist',
    ...
    def set_ip_allowlist(
        self,
        ip_allowlist_entry: List[IPAllowlistEntry],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._set_ip_allowlist_serialize(
            ip_allowlist_entry=ip_allowlist_entry,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def set_ip_allowlist_with_http_info(
        self,
        ip_allowlist_entry: List[IPAllowlistEntry],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def set_ip_allowlist_without_preload_content(
        self,
        ip_allowlist_entry: List[IPAllowlistEntry],
        _request_timeout: Union[
            None,
    ...
    def _set_ip_allowlist_serialize(
        self,
        ip_allowlist_entry,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if ip_allowlist_entry is not None:
            _body_params = ip_allowlist_entry
