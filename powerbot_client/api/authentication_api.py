...
class AuthenticationApi:
    ...
    def add_api_key(
        self,
        value: NewApiKey,
        x_exchange_password: Annotated[Optional[StrictStr], Field(description="Password for the exchange user the server is using to connect to the exchange - **ONLY REQUIRED IN PRODUCTION and if you are connected with a master-API-key**")] = None,
        ...
        _param = self._add_api_key_serialize(
            value=value,
            x_exchange_password=x_exchange_password,
    ...
    def _add_api_key_serialize(
        ...
        if x_exchange_password is not None:
            _header_params['X-Exchange-Password'] = x_exchange_password
    ...
    def delete_api_key(
        self,
        name: Annotated[StrictStr, Field(description="Name of API key")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_api_keys_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ApiKeyDetails]]:
        """List API keys
    ...
    @validate_call
    def get_current_api_key_portfolios(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_current_api_key_portfolios_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_current_api_key_portfolios_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_current_api_key_portfolios_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_current_api_key_portfolios_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def update_api_key(
        self,
        name: Annotated[StrictStr, Field(description="name of the API key")],
        value: UpdatedApiKey,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def update_api_key_portfolios(
        self,
        name: Annotated[StrictStr, Field(description="Name of API key")],
        portfolio_access_change: ApiKeyPortfolioUpdate,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_api_key_portfolios_serialize(
            name=name,
            portfolio_access_change=portfolio_access_change,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_api_key_portfolios_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Name of API key")],
        portfolio_access_change: ApiKeyPortfolioUpdate,
        _request_timeout: Union[
    ...
    @validate_call
    def update_api_key_portfolios_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Name of API key")],
        portfolio_access_change: ApiKeyPortfolioUpdate,
        _request_timeout: Union[
    ...
    def _update_api_key_portfolios_serialize(
        self,
        name,
        ...
        # process the form parameters
        # process the body parameter
        if portfolio_access_change is not None:
            _body_params = portfolio_access_change
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api-key/{name}/portfolios',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
