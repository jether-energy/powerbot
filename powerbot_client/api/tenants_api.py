...
class TenantsApi:
    ...
    def delete_tenant(
        self,
        id: Annotated[StrictStr, Field(description="id of the tenant (not equal to the tenant's name)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    def get_tenant_risk_management(
        self,
        id: Annotated[StrictStr, Field(description="id of the tenant (not equal to the tenant's name)")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_tenant_risk_management_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_tenant_risk_management_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="id of the tenant (not equal to the tenant's name)")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_tenant_risk_management_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="id of the tenant (not equal to the tenant's name)")],
        _request_timeout: Union[
            None,
    ...
    def _get_tenant_risk_management_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenant/{id}/risk-management',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_tenant(
        self,
        id: Annotated[StrictStr, Field(description="id of the tenant")],
        value: UpdatedTenant,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def update_tenant_risk_management_settings(
        self,
        id: Annotated[StrictStr, Field(description="id of the tenant (not equal to the tenant's name)")],
        ...
        _param = self._update_tenant_risk_management_settings_serialize(
            id=id,
            value=value,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_tenant_risk_management_settings_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="id of the tenant (not equal to the tenant's name)")],
        value: RiskManagementSettings,
        _request_timeout: Union[
    ...
    @validate_call
    def update_tenant_risk_management_settings_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="id of the tenant (not equal to the tenant's name)")],
        value: RiskManagementSettings,
        _request_timeout: Union[
    ...
    def _update_tenant_risk_management_settings_serialize(
        self,
        id,
        value,
        _request_auth,
