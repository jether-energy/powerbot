...
class OrderBookEntry(BaseModel):
    ...
    order_entry_time: Optional[datetime] = None
    price: Optional[Union[StrictFloat, StrictInt]] = None
    quantity: Optional[Union[StrictFloat, StrictInt]] = None
    exe_restriction: Optional[StrictStr] = Field(default=None, alias="exeRestriction")
    type: Optional[StrictStr] = None
    own_order: Optional[StrictBool] = Field(default=None, description="True if the order belongs to the active exchange user. Only present for active orders.")
    __properties: ClassVar[List[str]] = ["order_id", "delivery_area", "contract_id", "order_entry_time", "price", "quantity", "exeRestriction", "type", "own_order"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "order_entry_time": obj.get("order_entry_time"),
            "price": obj.get("price"),
            "quantity": obj.get("quantity"),
            "exeRestriction": obj.get("exeRestriction"),
            "type": obj.get("type"),
            "own_order": obj.get("own_order")
        })
        return _obj
