...
class Curve(BaseModel):
    ...
    """ # noqa: E501
    contract_id: StrictStr = Field(description="The contract ID of the curve.")
    comment: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="The comment of the curve. This field will be identical across all curves in case its a nordpool order.")
    curve_points: Annotated[List[CurvePoint], Field(min_length=2)]
    __properties: ClassVar[List[str]] = ["contract_id", "comment", "curve_points"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in curve_points (list)
        _items = []
        if self.curve_points:
            for _item in self.curve_points:
                if _item:
                    _items.append(_item.to_dict())
            _dict['curve_points'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "curve_points": [CurvePoint.from_dict(_item) for _item in obj["curve_points"]] if obj.get("curve_points") is not None else None
        })
        return _obj
