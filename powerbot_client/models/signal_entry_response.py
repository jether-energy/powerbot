...
class SignalEntryResponse(BaseModel):
    ...
    SignalEntryResponse
    """ # noqa: E501
    results: Optional[List[SignalEntryResult]] = Field(default=None, description="Contains an entry for each signal that was applied (modified/created) or had an error. Signals without changes are omitted.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [SignalEntryResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
