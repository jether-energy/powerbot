...
from pydantic import BaseModel, ConfigDict, Field, SecretStr, StrictBytes, StrictStr
from typing import Any, ClassVar, Dict, List, Optional, Union
from typing import Optional, Set
from typing_extensions import Self

class AuctionCredentials(BaseModel):
    """
    The login credentials for an exchange.
    """ # noqa: E501
    username: StrictStr = Field(description="The username of the exchange account.")
    password: SecretStr = Field(description="The password of the exchange account.")
    certificate_bundle: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="Base64 encoded client certificate bundle, only pkcs#12 bundles are supported.")
    certificate_password: Optional[SecretStr] = Field(default=None, description="Password for the client certificate bundle.")
    __properties: ClassVar[List[str]] = ["username", "password", "certificate_bundle", "certificate_password"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "certificate_bundle": obj.get("certificate_bundle"),
