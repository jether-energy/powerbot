...
class AuctionExchangePortfolioDeliveryArea(BaseModel):
    """
    The delivery areas of the exchange portfolio, grouped by currency.
    """ # noqa: E501
    currency: StrictStr
    delivery_area: StrictStr
    powerbot_portfolio_id: Optional[StrictStr] = Field(default=None, description="The powerbot portfolio ID to which the delivery area + exchange portfolio is mapped.")
    __properties: ClassVar[List[str]] = ["currency", "delivery_area", "powerbot_portfolio_id"]
