...
class LimitViolation(BaseModel):
    ...
    delivery_area: Optional[StrictStr] = Field(default=None, alias="deliveryArea")
    violation_type: Optional[StrictStr] = Field(default=None, alias="violationType")
    __properties: ClassVar[List[str]] = ["message", "contractId", "deliveryArea", "violationType"]
    ...
    def violation_type_validate_enum(cls, value):
        ...
        if value not in set(['CASH_LIMIT', 'POSITION_LIMIT', 'POSITION_EXPECTATION', 'OTR_LIMIT', 'ORDER_QUOTA_LIMIT']):
            raise ValueError("must be one of enum values ('CASH_LIMIT', 'POSITION_LIMIT', 'POSITION_EXPECTATION', 'OTR_LIMIT', 'ORDER_QUOTA_LIMIT')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deliveryArea": obj.get("deliveryArea"),
