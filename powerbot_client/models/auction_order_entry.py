...
class AuctionOrderEntry(BaseModel):
    """
    AuctionOrderEntry
    """ # noqa: E501
    auction_id: StrictStr = Field(description="The ID of the auction.")
    delivery_area: StrictStr = Field(description="The designated delivery area of the order.")
    portfolio_id: StrictStr = Field(description="The portfolio ID of the order.")
    order_data: AuctionOrderData
    __properties: ClassVar[List[str]] = ["auction_id", "delivery_area", "portfolio_id", "order_data"]
