...
class AtcStatus(BaseModel):
    """
    AtcStatus
    """ # noqa: E501
    status: MarketState
    status_text: Optional[StrictStr] = None
    heartbeat_as_of: Optional[datetime] = Field(default=None, description="The timestamp when the last heartbeat of the hub-to-hub module has been received (should be not older than 5 seconds)")
    __properties: ClassVar[List[str]] = ["status", "status_text", "heartbeat_as_of"]
