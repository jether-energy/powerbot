...
class SaveSettings(BaseModel):
    ...
    """ # noqa: E501
    order_confirmation: Optional[AuctionOrderConfirmation] = None
    __properties: ClassVar[List[str]] = ["order_confirmation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "order_confirmation": obj.get("order_confirmation")
        })
        return _obj
