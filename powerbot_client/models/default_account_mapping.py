...
class DefaultAccountMapping(BaseModel):
    """
    ...
    """ # noqa: E501
    exchange: Exchange
    mapping: Dict[str, StrictStr] = Field(description="A 1:1 map of delivery areas codes to account IDs")
    __properties: ClassVar[List[str]] = ["exchange", "mapping"]
