...
class OrderBookDepthValue(BaseModel):
    """
    OrderBookDepthValue
    """ # noqa: E501
    depth: Optional[Union[StrictFloat, StrictInt]] = None
    average_bid: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The average bid price for the given orderbook depth.")
    average_ask: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The average ask price for the given orderbook depth.")
    __properties: ClassVar[List[str]] = ["depth", "average_bid", "average_ask"]
