...
class ContractItem(BaseModel):
    ...
    revision_no: Optional[StrictInt] = None
    ...
    delivery_area_states: Optional[List[DeliveryAreaState]] = None
    __properties: ClassVar[List[str]] = ["exchange", "product", "contract_id", "type", "revision_no", "state", "name", "delivery_start", "delivery_end", "contract_details", "delivery_areas", "delivery_area_states"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in delivery_area_states (list)
        _items = []
        if self.delivery_area_states:
            for _item in self.delivery_area_states:
                if _item:
                    _items.append(_item.to_dict())
            _dict['delivery_area_states'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contract_details": obj.get("contract_details"),
            "delivery_areas": obj.get("delivery_areas"),
            "delivery_area_states": [DeliveryAreaState.from_dict(_item) for _item in obj["delivery_area_states"]] if obj.get("delivery_area_states") is not None else None
        })
        return _obj
