...
class Credentials(BaseModel):
    ...
    Credentials
    """ # noqa: E501
    username: Optional[StrictStr] = Field(default=None, description="The username provided by the exchange")
    password: Optional[SecretStr] = Field(default=None, description="The exchange password. For Nordpool, this refers to the password from the exchange and not the secret.")
    mfa_secret: Optional[StrictStr] = Field(default=None, description="Multi factor authentication secret. This is only required if MFA is activated.  **Note**: At this moment only M7 (HUPX, SouthPool, TGE, EPEX, SEMO, OPCOM) supports MFA.")
    __properties: ClassVar[List[str]] = ["username", "password", "mfa_secret"]
