...
class OwnTradeChanges(BaseModel):
    """
    OwnTradeChanges
    """ # noqa: E501
    ...
    internal_trades: Optional[List[InternalTrade]] = Field(default=None, alias="internalTrades")
    __properties: ClassVar[List[str]] = ["messageClass", "emittedAt", "trades", "internalTrades"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "internalTrades": [InternalTrade.from_dict(_item) for _item in obj["internalTrades"]] if obj.get("internalTrades") is not None else None
        })
        return _obj
