...
class OwnOrderChanges(BaseModel):
    """
    OwnOrderChanges
    """ # noqa: E501
    ...
    orders: Optional[List[OwnOrder]] = None
    __properties: ClassVar[List[str]] = ["messageClass", "emittedAt", "orders"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orders": [OwnOrder.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
