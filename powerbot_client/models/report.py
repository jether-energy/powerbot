...
class Report(BaseModel):
    ...
    cl_ordr_id: Optional[StrictStr] = Field(default=None, alias="clOrdrId")
    txt: Optional[StrictStr] = None
    net_cash_position: Optional[Union[StrictFloat, StrictInt]] = None
    currency: Optional[StrictStr] = None
    report_elements: Optional[List[ReportElement]] = Field(default=None, alias="reportElements")
    __properties: ClassVar[List[str]] = ["api_timestamp", "clOrdrId", "txt", "net_cash_position", "currency", "reportElements"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in report_elements (list)
        _items = []
        if self.report_elements:
            for _item in self.report_elements:
                if _item:
                    _items.append(_item.to_dict())
            _dict['reportElements'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reportElements": [ReportElement.from_dict(_item) for _item in obj["reportElements"]] if obj.get("reportElements") is not None else None
        })
        return _obj
