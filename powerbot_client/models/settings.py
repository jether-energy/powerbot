...
class Settings(BaseModel):
    ...
    """ # noqa: E501
    default_account_ids: Optional[List[DefaultAccountMapping]] = None
    __properties: ClassVar[List[str]] = ["default_account_ids"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in default_account_ids (list)
        _items = []
        if self.default_account_ids:
            for _item in self.default_account_ids:
                if _item:
                    _items.append(_item.to_dict())
            _dict['default_account_ids'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "default_account_ids": [DefaultAccountMapping.from_dict(_item) for _item in obj["default_account_ids"]] if obj.get("default_account_ids") is not None else None
        })
        return _obj
