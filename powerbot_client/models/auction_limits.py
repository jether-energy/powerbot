...
class AuctionLimits(BaseModel):
    ...
    delivery_area: Optional[StrictStr] = Field(default=None, description="The delivery area to which the limits apply to.")
    max_netpos_limit: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="The maximum position, e.g. buy position allowed for a single contract of an auction.")
    min_netpos_limit: Optional[Union[Annotated[float, Field(le=0, strict=True)], Annotated[int, Field(le=0, strict=True)]]] = Field(default=None, description="The minimum position, e.g. sell position, allowed for a single contract of an auction.")
    __properties: ClassVar[List[str]] = ["exchange", "delivery_area", "max_netpos_limit", "min_netpos_limit"]
