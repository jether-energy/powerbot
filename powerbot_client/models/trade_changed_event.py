...
class TradeChangedEvent(BaseModel):
    """
    TradeChangedEvent
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["messageClass", "delivery_area", "sell_portfolio_id", "buy_portfolio_id", "emittedAt", "trade_id", "trade_type", "state", "delivery_start", "delivery_end"]
    ...
    def trade_type_validate_enum(cls, value):
        ...
        if value not in set(['INTERNAL', 'PUBLIC']):
            raise ValueError("must be one of enum values ('INTERNAL', 'PUBLIC')")
        return value
