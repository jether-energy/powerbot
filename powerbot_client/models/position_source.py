...
class PositionSource(BaseModel):
    ...
    positions: Optional[List[PositionSourceValue]] = None
    __properties: ClassVar[List[str]] = ["source", "positions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "positions": [PositionSourceValue.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None
        })
        return _obj
