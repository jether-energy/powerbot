...
class NewPortfolio(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "type", "tenant_id", "settings", "risk_management"]

    @field_validator('id')
    def id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"[a-zA-Z0-9._-]{1,5}", value):
            raise ValueError(r"must validate the regular expression /[a-zA-Z0-9._-]{1,5}/")
        return value
