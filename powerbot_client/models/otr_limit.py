...
class OtrLimit(BaseModel):
    """
    OtrLimit
    """ # noqa: E501
    exchange: Exchange
    delivery_area: StrictStr = Field(description="The Energy Identification Code (EIC).")
    otr_limit: Union[StrictFloat, StrictInt] = Field(description="The order-to-trade-ratio limit for the particular exchange and delivery-area. It is calculated for each timeframe of a particular contract (XBID and LOCAL Contract).")
    __properties: ClassVar[List[str]] = ["exchange", "delivery_area", "otr_limit"]
