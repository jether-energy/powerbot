...
class OrderActionQuotaLimit(BaseModel):
    """
    OrderActionQuotaLimit
    """ # noqa: E501
    exchange: Exchange
    order_quota_limit: Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]] = Field(description="The order action quota limit allows to restrict the order action quota of a tenant/portfolio. Without a limit set, orders can be placed until 100% of the quota set by the exchange is used.")
    __properties: ClassVar[List[str]] = ["exchange", "order_quota_limit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "order_quota_limit": obj.get("order_quota_limit")
        })
        return _obj
