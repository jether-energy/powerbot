...
class HistoricOrdersResponse(BaseModel):
    """
    HistoricOrdersResponse
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="Provide this value as the 'page_token' parameter to retrieve the next page of results.  If this header is blank, there is no more data to retrieve.")
    contract_id: StrictStr
    delivery_area: StrictStr
    revisions: List[OrderBookRevision]
    __properties: ClassVar[List[str]] = ["next_page_token", "contract_id", "delivery_area", "revisions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "revisions": [OrderBookRevision.from_dict(_item) for _item in obj["revisions"]] if obj.get("revisions") is not None else None
        })
        return _obj
