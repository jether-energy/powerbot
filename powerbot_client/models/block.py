...
class Block(BaseModel):
    ...
    Block
    """ # noqa: E501
    id: StrictStr = Field(description="The identifier of the block.")
    price: Union[StrictFloat, StrictInt] = Field(description="The price of the block.")
    minimum_acceptance_ratio: Union[StrictFloat, StrictInt] = Field(description="The minimum acceptance ratio of the block.")
    comment: Optional[StrictStr] = Field(default=None, description="The comment of the block.")
    type: BlockType
    type_value: Optional[StrictStr] = Field(default=None, description="The value relevant for the block type. E.g. the ID of the parent block for a linked block or the group ID for an exclusive block.")
    state: Optional[BlockState] = None
    periods: List[BlockPeriod]
    __properties: ClassVar[List[str]] = ["id", "price", "minimum_acceptance_ratio", "comment", "type", "type_value", "state", "periods"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "price": obj.get("price"),
            "minimum_acceptance_ratio": obj.get("minimum_acceptance_ratio"),
            "comment": obj.get("comment"),
            "type": obj.get("type"),
            "type_value": obj.get("type_value"),
            "state": obj.get("state"),
            "periods": [BlockPeriod.from_dict(_item) for _item in obj["periods"]] if obj.get("periods") is not None else None
        })
        return _obj
