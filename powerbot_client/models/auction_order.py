...
class AuctionOrder(BaseModel):
    ...
    """ # noqa: E501
    order_id: StrictStr = Field(description="The ID of the current order revision.")
    auction_id: StrictStr = Field(description="The ID of the auction.")
    delivery_area: StrictStr = Field(description="The delivery area of the order.")
    portfolio_id: StrictStr = Field(description="The ID of the portfolio.")
    currency: Optional[StrictStr] = Field(default=None, description="The currency of the order.")
    modified_at: datetime = Field(description="The timestamp of the last order modification.")
    revision: StrictInt
    state: AuctionOrderState
    type: Optional[AuctionOrderType] = None
    order_data: AuctionOrderData
    __properties: ClassVar[List[str]] = ["order_id", "auction_id", "delivery_area", "portfolio_id", "currency", "modified_at", "revision", "state", "type", "order_data"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.order_data:
            _dict['order_data'] = self.order_data.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "type": obj.get("type"),
            "order_data": AuctionOrderData.from_dict(obj["order_data"]) if obj.get("order_data") is not None else None
        })
        return _obj
