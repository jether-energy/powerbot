...
class BlockPeriod(BaseModel):
    ...
    A period of a block.
    """ # noqa: E501
    contract_id: StrictStr = Field(description="The contract ID of the period.")
    quantity: Union[StrictFloat, StrictInt] = Field(description="The quantity of the period.")
    __properties: ClassVar[List[str]] = ["contract_id", "quantity"]
