...
class AuctionContract(BaseModel):
    """
    A contract of an auction
    """ # noqa: E501
    contract_id: StrictStr = Field(description="The ID of the contract.")
    delivery_start: datetime = Field(description="The delivery start of the contract.")
    delivery_end: datetime = Field(description="The delivery end of the contract.")
    delivery_areas: List[StrictStr] = Field(description="The delivery areas where the contract is tradeable.")
    __properties: ClassVar[List[str]] = ["contract_id", "delivery_start", "delivery_end", "delivery_areas"]
