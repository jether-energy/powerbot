...
class DeliveryAreaState(BaseModel):
    """
    DeliveryAreaState
    """ # noqa: E501
    delivery_area: Optional[StrictStr] = None
    state: Optional[StrictStr] = Field(default=None, description="State of the delivery area")
    ...
    __properties: ClassVar[List[str]] = ["delivery_area", "state", "trading_start", "trading_end"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['ACTIVE', 'INACTIVE', 'HIBERNATE', 'STANDBY']):
            raise ValueError("must be one of enum values ('ACTIVE', 'INACTIVE', 'HIBERNATE', 'STANDBY')")
        return value
