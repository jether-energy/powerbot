...
class Auction(BaseModel):
    ...
    The auction object.
    """ # noqa: E501
    auction_id: StrictStr = Field(description="The ID of the auction.")
    name: StrictStr = Field(description="The name of the auction.")
    delivery_start: datetime = Field(description="The first delivery start of the auction.")
    delivery_end: datetime = Field(description="The last delivery end of the auction.")
    delivery_areas: List[StrictStr] = Field(description="The delivery areas where the auction takes place.")
    contracts: List[AuctionContract]
    order_entry_start: Optional[datetime] = Field(default=None, description="The time after which orders can be started to be placed.")
    order_entry_end: datetime = Field(description="The time after which order placement is closed.")
    state: AuctionState
    __properties: ClassVar[List[str]] = ["auction_id", "name", "delivery_start", "delivery_end", "delivery_areas", "contracts", "order_entry_start", "order_entry_end", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contracts": [AuctionContract.from_dict(_item) for _item in obj["contracts"]] if obj.get("contracts") is not None else None,
            "order_entry_start": obj.get("order_entry_start"),
            "order_entry_end": obj.get("order_entry_end"),
            "state": obj.get("state")
        })
        return _obj
