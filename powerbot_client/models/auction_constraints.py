...
class AuctionConstraints(BaseModel):
    """
    Constraints of an auction.
    """ # noqa: E501
    min_price: Union[StrictFloat, StrictInt]
    max_price: Union[StrictFloat, StrictInt]
    price_tick: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["min_price", "max_price", "price_tick"]
