...
class SignalSourceDurations(BaseModel):
    """
    SignalSourceDurations
    """ # noqa: E501
    source: Optional[StrictStr] = Field(default=None, description="The unique signal source")
    durations: Optional[List[StrictInt]] = Field(default=None, description="The durations of the source with their respective delivery period.")
    __properties: ClassVar[List[str]] = ["source", "durations"]
