...
class OrderBookStatistics(BaseModel):
    ...
    contracts: Optional[List[OrderBookStatisticsContract]] = None
    __properties: ClassVar[List[str]] = ["delivery_start", "delivery_end", "contracts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contracts": [OrderBookStatisticsContract.from_dict(_item) for _item in obj["contracts"]] if obj.get("contracts") is not None else None
        })
        return _obj
