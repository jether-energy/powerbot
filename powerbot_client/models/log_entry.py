...
class LogEntry(BaseModel):
    ...
    text: StrictStr = Field(description="The content of your log entry")
    as_of: datetime = Field(description="Should be set to the time (UTC) when the log entry was emitted by your system")
    category: Optional[StrictStr] = Field(default=None, description="An optional category of the log entry")
    severity: Optional[Severity] = Severity.MED
    portfolio_id: Optional[StrictStr] = Field(default=None, description="The portfolio for which the log entry is applicable")
    __properties: ClassVar[List[str]] = ["id", "received", "text", "as_of", "category", "severity", "portfolio_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "severity": obj.get("severity") if obj.get("severity") is not None else Severity.MED,
