...
class ValidationSchema(BaseModel):
    ...
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="The name of the schema.")
    version: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="The version of the related algorithm that uses this schema.")
    description: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(default=None, description="A description text detailing information regarding the schema.")
    parameters: Dict[str, Any] = Field(description="The contents of the schema")
    __properties: ClassVar[List[str]] = ["type", "name", "version", "description", "parameters"]
