...
class PositionSourceValue(BaseModel):
    """
    PositionSourceValue
    """ # noqa: E501
    duration: Optional[StrictInt] = Field(default=None, description="signal duration in minutes")
    ...
    __properties: ClassVar[List[str]] = ["duration", "delivery_start", "delivery_end", "position_long", "position_short"]
