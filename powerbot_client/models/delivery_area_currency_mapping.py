...
class DeliveryAreaCurrencyMapping(BaseModel):
    """
    ...
    """ # noqa: E501
    delivery_area: StrictStr = Field(description="The delivery area of the mapping.")
    currency: StrictStr = Field(description="The currency of the mapping.")
    __properties: ClassVar[List[str]] = ["delivery_area", "currency"]
