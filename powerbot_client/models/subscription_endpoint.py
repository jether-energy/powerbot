...
class SubscriptionEndpoint(BaseModel):
    ...
    """ # noqa: E501
    protocol: Optional[List[StrictStr]] = None
    path: Optional[StrictStr] = None
    destination: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    payload_classes: Optional[List[StrictStr]] = Field(default=None, alias="payloadClasses")
    __properties: ClassVar[List[str]] = ["protocol", "path", "destination", "description", "payloadClasses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payloadClasses": obj.get("payloadClasses")
        })
        return _obj
