...
class AuctionExchangePortfolio(BaseModel):
    """
    ...
    """ # noqa: E501
    exchange_portfolio_name: Optional[StrictStr] = Field(default=None, description="The name of the portfolio. Unique across portfolios.")
    delivery_areas: List[AuctionExchangePortfolioDeliveryArea]
    __properties: ClassVar[List[str]] = ["exchange_portfolio_name", "delivery_areas"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in delivery_areas (list)
        _items = []
        if self.delivery_areas:
            for _item in self.delivery_areas:
                if _item:
                    _items.append(_item.to_dict())
            _dict['delivery_areas'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "delivery_areas": [AuctionExchangePortfolioDeliveryArea.from_dict(_item) for _item in obj["delivery_areas"]] if obj.get("delivery_areas") is not None else None
        })
        return _obj
