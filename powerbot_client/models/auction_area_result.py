...
class AuctionAreaResult(BaseModel):
    """
    The results of a contract in one delivery area
    """ # noqa: E501
    delivery_area: StrictStr = Field(description="The delivery area of the result.")
    clearing_prices: Optional[List[CurrencyPrice]] = Field(default=None, description="The prices at which the auction was cleared for each currency.")
    total_quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total quantity traded for the contract in this delivery area.")
    __properties: ClassVar[List[str]] = ["delivery_area", "clearing_prices", "total_quantity"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in clearing_prices (list)
        _items = []
        if self.clearing_prices:
            for _item in self.clearing_prices:
                if _item:
                    _items.append(_item.to_dict())
            _dict['clearing_prices'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "clearing_prices": [CurrencyPrice.from_dict(_item) for _item in obj["clearing_prices"]] if obj.get("clearing_prices") is not None else None,
