...
class MarketStatusChangedEvent(BaseModel):
    ...
    market_status: Optional[MarketStatus] = Field(default=None, alias="marketStatus")
    __properties: ClassVar[List[str]] = ["messageClass", "emittedAt", "marketStatus"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of market_status
        if self.market_status:
            _dict['marketStatus'] = self.market_status.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "marketStatus": MarketStatus.from_dict(obj["marketStatus"]) if obj.get("marketStatus") is not None else None
        })
        return _obj
