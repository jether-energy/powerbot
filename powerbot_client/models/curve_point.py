...
class CurvePoint(BaseModel):
    ...
    """ # noqa: E501
    price: Union[StrictFloat, StrictInt] = Field(description="The price point.")
    quantity: Union[StrictFloat, StrictInt] = Field(description="The quantity point. To specify a sell quantity, use a negative value.")
