...
class AuctionContractResult(BaseModel):
    """
    The result of a contract of an auction
    """ # noqa: E501
    contract: AuctionContract
    delivery_areas: List[AuctionAreaResult] = Field(description="The delivery areas of the contract")
    __properties: ClassVar[List[str]] = ["contract", "delivery_areas"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contract": AuctionContract.from_dict(obj["contract"]) if obj.get("contract") is not None else None,
            "delivery_areas": [AuctionAreaResult.from_dict(_item) for _item in obj["delivery_areas"]] if obj.get("delivery_areas") is not None else None
        })
        return _obj
