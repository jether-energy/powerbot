...
class CapacityChanges(BaseModel):
    ...
    changes: Optional[List[Capacity]] = None
    __properties: ClassVar[List[str]] = ["messageClass", "emittedAt", "changes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "changes": [Capacity.from_dict(_item) for _item in obj["changes"]] if obj.get("changes") is not None else None
        })
        return _obj
