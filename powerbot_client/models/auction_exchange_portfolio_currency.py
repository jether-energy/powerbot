...
class AuctionExchangePortfolioCurrency(BaseModel):
    """
    AuctionExchangePortfolioCurrency
    """ # noqa: E501
    exchange_portfolio_name: Optional[StrictStr] = None
    currency: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["exchange_portfolio_name", "currency"]
