...
class ProductInformation(BaseModel):
    ...
    price_currency: Optional[StrictStr] = Field(default=None, description="the price currency of the underlying contracts")
    quantity_unit: Optional[StrictStr] = Field(default=None, description="the quantity unit of the underlying contracts")
    duration_minutes: Optional[StrictInt] = Field(default=None, description="the duration of the product's contracts in minutes")
    location_required: Optional[StrictBool] = Field(default=None, description="Indicates if the product requires location information within the delivery area.")
    __properties: ClassVar[List[str]] = ["product_name", "delivery_area", "price_currency", "quantity_unit", "duration_minutes", "location_required"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "location_required": obj.get("location_required")
        })
        return _obj
