...
class ContractStatistics(BaseModel):
    ...
    ContractStatistics
    """ # noqa: E501
    delivery_start: Optional[datetime] = Field(default=None, description="The delivery start time of the contract")
    delivery_end: Optional[datetime] = Field(default=None, description="The delivery end time of the contract")
    contract_id: Optional[List[StrictStr]] = None
    volume: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total volume of all trades  All trades of contracts with the requested delivery period are included. Each side of a trade is counted separately, so a trade with both sides in one of the requested delivery areas gets counted twice. Self trades registered at the exchange and internal trades registered by PowerBot are excluded.")
    average_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The volume weighted average price  All trades of contracts with the requested delivery period are included. Each side of a trade is counted separately, so a trade with both sides in one of the requested delivery areas gets counted twice. Self trades registered at the exchange and internal trades registered by PowerBot are excluded.")
    __properties: ClassVar[List[str]] = ["delivery_start", "delivery_end", "contract_id", "volume", "average_price"]
