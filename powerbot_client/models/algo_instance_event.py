...
class AlgoInstanceEvent(BaseModel):
    """
    AlgoInstanceEvent
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["messageClass", "algorithm", "emittedAt", "change"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "algorithm": AlgoDetails.from_dict(obj["algorithm"]) if obj.get("algorithm") is not None else None,
