...
class NewInternalTrade(BaseModel):
    """
    NewInternalTrade
    """ # noqa: E501
    ...
    exec_time: datetime = Field(description="The timestamp when the trade was executed (UTC time zone)")
    ...
    sell_txt: Optional[StrictStr] = Field(default=None, description="the custom text of the sell order")
    ...
    price: Union[StrictFloat, StrictInt] = Field(description="Price of the trade")
    quantity: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["exchange", "delivery_start", "delivery_end", "exec_time", "buy_delivery_area", "buy_txt", "buy_portfolio_id", "buy_aggressor_indicator", "sell_delivery_area", "sell_txt", "sell_portfolio_id", "sell_aggressor_indicator", "contract_id", "price", "quantity"]
