...
class ContractChangedEvent(BaseModel):
    """
    ...
    contract_name: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["messageClass", "emittedAt", "contract_id", "contract_name", "contract_type", "delivery_area", "trading_enabled", "delivery_start", "delivery_end"]
