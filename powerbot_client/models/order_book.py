...
class OrderBook(BaseModel):
    ...
    OrderBook
    """ # noqa: E501
    product: Optional[StrictStr] = Field(default=None, description="The orderbook's product")
    product_details: Optional[Dict[str, Any]] = Field(default=None, description="The product's details (as delivered by the backend)")
    delivery_area: Optional[StrictStr] = Field(default=None, description="The EIC of the delivery area of the order book")
    ...
    contracts: Optional[List[Contract]] = Field(default=None, description="The contracts of the orderbook")
    __properties: ClassVar[List[str]] = ["product", "product_details", "delivery_area", "price_currency", "quantity_unit", "contracts"]
