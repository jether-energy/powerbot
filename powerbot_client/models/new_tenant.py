...
class NewTenant(BaseModel):
    ...
    NewTenant
    """ # noqa: E501
    id: Annotated[str, Field(strict=True)] = Field(description="A unique id (max 5 alphanumeric characters) of the tenant")
    name: StrictStr = Field(description="The name of the tenant")
    risk_management: RiskManagementSettings
    __properties: ClassVar[List[str]] = ["id", "name", "risk_management"]
