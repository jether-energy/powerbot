...
class OrderCountLimit(BaseModel):
    """
    ...
    """ # noqa: E501
    exchange: Exchange
    rolling_window_seconds: Annotated[int, Field(le=86400, strict=True, ge=1)] = Field(description="The rolling window size defines a timeframe in seconds, where orders placed or modified are counted.")
    allowed_order_count: Annotated[int, Field(strict=True, ge=1)] = Field(description="The amount of allowed orders added or modified in a given timeframe.")
    __properties: ClassVar[List[str]] = ["exchange", "rolling_window_seconds", "allowed_order_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rolling_window_seconds": obj.get("rolling_window_seconds"),
            "allowed_order_count": obj.get("allowed_order_count")
        })
        return _obj
