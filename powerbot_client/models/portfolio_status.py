...
class PortfolioStatus(BaseModel):
    ...
    """ # noqa: E501
    rolling_window_counts: Optional[List[RollingWindowCount]] = None
    __properties: ClassVar[List[str]] = ["rolling_window_counts"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in rolling_window_counts (list)
        _items = []
        if self.rolling_window_counts:
            for _item in self.rolling_window_counts:
                if _item:
                    _items.append(_item.to_dict())
            _dict['rolling_window_counts'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rolling_window_counts": [RollingWindowCount.from_dict(_item) for _item in obj["rolling_window_counts"]] if obj.get("rolling_window_counts") is not None else None
        })
        return _obj
