...
class AuctionTrade(BaseModel):
    """
    todo
    """ # noqa: E501
    id: StrictStr = Field(description="The ID of the trade, provided by the exchange.")
    auction_id: StrictStr = Field(description="The ID of the auction the trade belongs to.")
    contract_id: StrictStr = Field(description="The ID of the contract the trade belongs to.")
    delivery_start: Optional[datetime] = Field(default=None, description="The delivery start of the trade.")
    delivery_end: Optional[datetime] = Field(default=None, description="The delivery end of the trade.")
    order_id: StrictStr = Field(description="The ID of the order the trade belongs to.")
    delivery_area: StrictStr = Field(description="The delivery area of the trade.")
    price: Union[StrictFloat, StrictInt] = Field(description="The price of the trade.")
    currency: Optional[StrictStr] = None
    quantity: Union[StrictFloat, StrictInt] = Field(description="The quantity of the trade.")
    state: AuctionTradeState
    user_id: StrictStr = Field(description="The exchange user that was used to place the order")
    __properties: ClassVar[List[str]] = ["id", "auction_id", "contract_id", "delivery_start", "delivery_end", "order_id", "delivery_area", "price", "currency", "quantity", "state", "user_id"]
