...
class SignalSearchResult(BaseModel):
    ...
    SignalSearchResult
    """ # noqa: E501
    signals: Optional[List[SignalSearchItem]] = Field(default=None, description="The object containing the found trading signals by 'findTradingSignals'. These trading signals are grouped by source, delivery area, portfolio ID and delivery period.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "signals": [SignalSearchItem.from_dict(_item) for _item in obj["signals"]] if obj.get("signals") is not None else None
        })
        return _obj
