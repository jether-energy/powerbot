...
class AuctionPositions(BaseModel):
    """
    AuctionPositions
    """ # noqa: E501
    net_pos: Optional[Union[StrictFloat, StrictInt]] = None
    min_net_pos: Optional[Union[StrictFloat, StrictInt]] = None
    max_net_pos: Optional[Union[StrictFloat, StrictInt]] = None
    abs_pos: Optional[Union[StrictFloat, StrictInt]] = None
    net_cash: Optional[Union[StrictFloat, StrictInt]] = None
    trades_spending: Optional[Union[StrictFloat, StrictInt]] = None
    trades_earnings: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["net_pos", "min_net_pos", "max_net_pos", "abs_pos", "net_cash", "trades_spending", "trades_earnings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "min_net_pos": obj.get("min_net_pos"),
            "max_net_pos": obj.get("max_net_pos"),
