...
class BulkContractStatistics(BaseModel):
    """
    BulkContractStatistics
    """ # noqa: E501
    statistics: Optional[List[ContractStatistics]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "statistics": [ContractStatistics.from_dict(_item) for _item in obj["statistics"]] if obj.get("statistics") is not None else None
        })
        return _obj
