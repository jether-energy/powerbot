...
class ApiKeyDetails(BaseModel):
    ...
    ApiKeyDetails
    """ # noqa: E501
    name: StrictStr = Field(description="A name for the API key, i.e. \"K1\"")
    description: Optional[StrictStr] = None
    type: ApiKeyType
    tenant_id: Optional[StrictStr] = None
    tenant_name: Optional[StrictStr] = None
    inherit_tenant_portfolios: StrictBool = Field(description="If true, all tenant portfolios are accessible.")
    portfolios: Optional[List[Portfolio]] = None
    tenant_risk_settings: Optional[RiskManagementSettings] = None
    can_read: StrictBool = Field(description="Set to true, if the API key should be able to read data from the exchange (order-book, trades, etc.)")
    can_trade: StrictBool = Field(description="Set to true, if the API key should be able to trade.")
    can_signal: StrictBool = Field(description="Set to true, if the API key should be allowed to submit signals")
    __properties: ClassVar[List[str]] = ["name", "description", "type", "tenant_id", "tenant_name", "inherit_tenant_portfolios", "portfolios", "tenant_risk_settings", "can_read", "can_trade", "can_signal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inherit_tenant_portfolios": obj.get("inherit_tenant_portfolios"),
            "portfolios": [Portfolio.from_dict(_item) for _item in obj["portfolios"]] if obj.get("portfolios") is not None else None,
