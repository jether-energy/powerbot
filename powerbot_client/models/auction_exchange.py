...
class AuctionExchange(BaseModel):
    """
    AuctionExchange
    """ # noqa: E501
    exchange: Exchange
    status: StrictStr = Field(description="The status of the exchange.")
    logged_in_username: Optional[StrictStr] = Field(default=None, description="The username of the currently logged in account.")
    __properties: ClassVar[List[str]] = ["exchange", "status", "logged_in_username"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LOGGED_IN', 'LOGGED_OUT', 'UNKNOWN']):
            raise ValueError("must be one of enum values ('LOGGED_IN', 'LOGGED_OUT', 'UNKNOWN')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "logged_in_username": obj.get("logged_in_username")
        })
        return _obj
