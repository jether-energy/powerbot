...
class OrderBookBulkStatistics(BaseModel):
    """
    OrderBookBulkStatistics
    """ # noqa: E501
    api_timestamp: Optional[datetime] = Field(default=None, description="The timestamp at which the calculation took place (UTC time zone).")
    delivery_area: Optional[StrictStr] = None
    statistics: Optional[List[OrderBookStatistics]] = None
    __properties: ClassVar[List[str]] = ["api_timestamp", "delivery_area", "statistics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statistics": [OrderBookStatistics.from_dict(_item) for _item in obj["statistics"]] if obj.get("statistics") is not None else None
        })
        return _obj
