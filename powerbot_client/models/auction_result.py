...
class AuctionResult(BaseModel):
    ...
    state: Optional[AuctionResultState] = None
    contract_results: Optional[List[AuctionContractResult]] = Field(default=None, description="The contracts of the auction.")
    __properties: ClassVar[List[str]] = ["auction_id", "delivery_start", "delivery_end", "state", "contract_results"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in contract_results (list)
        _items = []
        if self.contract_results:
            for _item in self.contract_results:
                if _item:
                    _items.append(_item.to_dict())
            _dict['contract_results'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": obj.get("state"),
            "contract_results": [AuctionContractResult.from_dict(_item) for _item in obj["contract_results"]] if obj.get("contract_results") is not None else None
        })
        return _obj
