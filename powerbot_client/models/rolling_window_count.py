...
class RollingWindowCount(BaseModel):
    """
    RollingWindowCount
    """ # noqa: E501
    rolling_window_seconds: Optional[StrictInt] = Field(default=None, description="The rolling window size defines a timeframe in seconds, where orders placed or modified are counted.")
    current_order_count: Optional[StrictInt] = Field(default=None, description="The amount of orders added or modified in a given timeframe.")
    __properties: ClassVar[List[str]] = ["rolling_window_seconds", "current_order_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "current_order_count": obj.get("current_order_count")
        })
        return _obj
