...
class Requests(BaseModel):
    ...
    """ # noqa: E501
    cpu: Optional[StrictStr] = Field(default=None, description="The number of CPU cores that will be assigned to the algorithm provided as a decimal number, e.g. \"0.5\", or \"millicpus\", e.g \"500m\".")
    memory: Optional[StrictStr] = Field(default=None, description="The amount of memory that will be assigned to the algorithm. The recommended format is a number followed by a suffix (e.g. Mi, Gi).")
