...
class LogEntryAdded(BaseModel):
    ...
    log_entry: Optional[LogEntry] = Field(default=None, alias="logEntry")
    __properties: ClassVar[List[str]] = ["messageClass", "emittedAt", "logEntry"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of log_entry
        if self.log_entry:
            _dict['logEntry'] = self.log_entry.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "logEntry": LogEntry.from_dict(obj["logEntry"]) if obj.get("logEntry") is not None else None
        })
        return _obj
