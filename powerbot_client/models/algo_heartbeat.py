...
class AlgoHeartbeat(BaseModel):
    """
    AlgoHeartbeat
    """ # noqa: E501
    status: Optional[InstanceHeartbeatStatus] = None
    status_text: Optional[StrictStr] = Field(default=None, description="Detail information about the status")
    __properties: ClassVar[List[str]] = ["status", "status_text"]
