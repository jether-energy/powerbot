...
class ExchangeCashLimit(BaseModel):
    """
    ExchangeCashLimit
    """ # noqa: E501
    currency: StrictStr = Field(description="The currency to limit")
    current_limit: Optional[Union[Annotated[float, Field(multiple_of=0.01, strict=True)], Annotated[int, Field(strict=True)]]] = Field(default=None, description="The current limit for the currency")
    configured_limit: Optional[Union[Annotated[float, Field(multiple_of=0.01, strict=True)], Annotated[int, Field(strict=True)]]] = Field(default=None, description="The configured limit for the currency")
    __properties: ClassVar[List[str]] = ["currency", "current_limit", "configured_limit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "current_limit": obj.get("current_limit"),
            "configured_limit": obj.get("configured_limit")
        })
        return _obj
