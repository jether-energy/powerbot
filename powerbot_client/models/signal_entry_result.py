...
class SignalEntryResult(BaseModel):
    """
    ...
    minutes_to_delivery: Optional[StrictInt] = None
    status: Optional[StrictStr] = None
    status_text: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["source", "delivery_area", "portfolio_id", "delivery_start", "delivery_end", "minutes_to_delivery", "status", "status_text"]
