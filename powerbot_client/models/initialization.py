...
class Initialization(BaseModel):
    ...
    order_books: Optional[List[OrderBookChanges]] = Field(default=None, alias="orderBooks")
    __properties: ClassVar[List[str]] = ["messageClass", "type", "orderBooks"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['ORDERBOOK']):
            raise ValueError("must be one of enum values ('ORDERBOOK')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "orderBooks": [OrderBookChanges.from_dict(_item) for _item in obj["orderBooks"]] if obj.get("orderBooks") is not None else None
        })
        return _obj
