...
class AlgoEvent(BaseModel):
    ...
    algorithm_id: Optional[StrictStr] = None
    algo_name: Optional[StrictStr] = None
    require_heartbeat_every_seconds: Optional[StrictInt] = None
    ...
    stop_status_text: Optional[StrictStr] = None
    action: Optional[AlgoStatus] = None
    __properties: ClassVar[List[str]] = ["messageClass", "algorithm_id", "algo_name", "require_heartbeat_every_seconds", "instance_id", "instance_parameters", "portfolio_id", "emittedAt", "stop_status_text", "action"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "instance_parameters": obj.get("instance_parameters"),
