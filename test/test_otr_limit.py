...
class TestOtrLimit(unittest.TestCase):
    """OtrLimit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OtrLimit:
        """Test OtrLimit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OtrLimit`
        """
        model = OtrLimit()
        if include_optional:
            return OtrLimit(
