...
class TestCapacityChanges(unittest.TestCase):
    """CapacityChanges unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CapacityChanges:
        """Test CapacityChanges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CapacityChanges`
        """
        model = CapacityChanges()
        if include_optional:
            return CapacityChanges(
                message_class = '',
                emitted_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                changes = [
                    powerbot_client.models.capacity.Capacity(
