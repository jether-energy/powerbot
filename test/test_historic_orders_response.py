...
class TestHistoricOrdersResponse(unittest.TestCase):
    """HistoricOrdersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HistoricOrdersResponse:
        """Test HistoricOrdersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HistoricOrdersResponse`
        """
        model = HistoricOrdersResponse()
        if include_optional:
            return HistoricOrdersResponse(
                next_page_token = '',
                contract_id = '',
                delivery_area = '',
                revisions = [
                    powerbot_client.models.order_book_revision.OrderBookRevision(
                        time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        revision_number = 56, 
                        buy_orders = [
                            powerbot_client.models.public_order_revision.PublicOrderRevision(
                                order_id = '', 
                                price = 1.337, 
                                quantity = 1.337, 
    ...
    def testHistoricOrdersResponse(self):
        """Test HistoricOrdersResponse"""
