...
class TestContractChangedEvent(unittest.TestCase):
    """ContractChangedEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContractChangedEvent:
        """Test ContractChangedEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContractChangedEvent`
        """
        model = ContractChangedEvent()
        if include_optional:
    ...
    def testContractChangedEvent(self):
        """Test ContractChangedEvent"""
