...
class TestOrderBookGroup(unittest.TestCase):
    """OrderBookGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderBookGroup:
        """Test OrderBookGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderBookGroup`
        """
        model = OrderBookGroup()
        if include_optional:
            return OrderBookGroup(
                ...
                changed_contract = powerbot_client.models.related_contract.RelatedContract(
                    contract_id = '', 
                    ...
                    best_own_bid_price = 12.4, 
                    best_own_bid_quantity = 34.0, 
                    best_own_ask_price = 18.4, 
                    best_own_ask_quantity = 18.4, 
                    best_third_party_bid_price = 12.4, 
                    best_third_party_bid_quantity = 34.0, 
                    best_third_party_ask_price = 18.4, 
                    best_third_party_ask_quantity = 18.4, 
                    last_price = 24.3, 
                    last_quantity = 15.3, ),
                related_contracts = [
                    powerbot_client.models.related_contract.RelatedContract(
                        contract_id = '', 
                        product = 'Intraday_Power_D', 
                        delivery_area = '', 
                        active_since = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
