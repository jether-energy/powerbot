...
class TestSignalSearchResult(unittest.TestCase):
    """SignalSearchResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignalSearchResult:
        """Test SignalSearchResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalSearchResult`
        """
        model = SignalSearchResult()
        if include_optional:
            return SignalSearchResult(
                signals = [
                    powerbot_client.models.signal_search_item.SignalSearchItem(
                        source = 'ETRMSystem', 
                        delivery_area = '', 
                        portfolio_id = '', 
                        delivery_start = '2023-01-01T09:15:31Z', 
                        delivery_end = '2023-01-01T09:15:31Z', 
                        time_slices = [
                            powerbot_client.models.signal_time_slice.SignalTimeSlice(
                                active = True, 
                                historic = True, 
                                deleted = True, 
                                received_at = '2023-01-01T09:15:31Z', 
                                updated_at = '2023-01-01T09:30:31Z', 
                                minutes_to_delivery = 56, 
                                revision = 56, 
                                locked = True, 
                                parameters = {"value1":"value1","value2":"value2","position_long":10.0,"position_short":3.0}, )
                            ], )
                    ]
            )
        else:
    ...
    def testSignalSearchResult(self):
        """Test SignalSearchResult"""
