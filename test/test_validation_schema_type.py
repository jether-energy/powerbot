...
class TestValidationSchemaType(unittest.TestCase):
    """ValidationSchemaType unit test stubs"""
    ...
    def testValidationSchemaType(self):
        """Test ValidationSchemaType"""
        # inst = ValidationSchemaType()
