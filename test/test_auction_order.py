...
class TestAuctionOrder(unittest.TestCase):
    """AuctionOrder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionOrder:
        """Test AuctionOrder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionOrder`
        """
        model = AuctionOrder()
        if include_optional:
            return AuctionOrder(
