...
class TestLimitViolation(unittest.TestCase):
    """LimitViolation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LimitViolation:
        """Test LimitViolation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LimitViolation`
        """
        model = LimitViolation()
        if include_optional:
            return LimitViolation(
                message = '',
                contract_id = '',
                delivery_area = '',
                violation_type = 'CASH_LIMIT'
            )
        else:
            return LimitViolation(
        )
