...
class TestBulkSignalResponse(unittest.TestCase):
    """BulkSignalResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkSignalResponse:
        """Test BulkSignalResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkSignalResponse`
        """
        model = BulkSignalResponse()
        if include_optional:
    ...
    def testBulkSignalResponse(self):
        """Test BulkSignalResponse"""
