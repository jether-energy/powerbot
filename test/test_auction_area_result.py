...
class TestAuctionAreaResult(unittest.TestCase):
    """AuctionAreaResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionAreaResult:
        """Test AuctionAreaResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionAreaResult`
        """
        model = AuctionAreaResult()
        if include_optional:
            return AuctionAreaResult(
                delivery_area = '',
                clearing_prices = [
    ...
    def testAuctionAreaResult(self):
        """Test AuctionAreaResult"""
