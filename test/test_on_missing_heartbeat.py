...
class TestOnMissingHeartbeat(unittest.TestCase):
    """OnMissingHeartbeat unit test stubs"""
    ...
    def testOnMissingHeartbeat(self):
        """Test OnMissingHeartbeat"""
        # inst = OnMissingHeartbeat()
