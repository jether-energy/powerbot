...
class TestAuctionExchangePortfolio(unittest.TestCase):
    """AuctionExchangePortfolio unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionExchangePortfolio:
        """Test AuctionExchangePortfolio
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionExchangePortfolio`
        """
        model = AuctionExchangePortfolio()
        if include_optional:
            return AuctionExchangePortfolio(
                exchange_portfolio_name = '',
                delivery_areas = [
                    powerbot_client.models.auction_exchange_portfolio_delivery_area.AuctionExchangePortfolioDeliveryArea(
                        currency = '', 
                        delivery_area = '', 
    ...
    def testAuctionExchangePortfolio(self):
        """Test AuctionExchangePortfolio"""
