...
class TestAuctionOrderData(unittest.TestCase):
    """AuctionOrderData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionOrderData:
        """Test AuctionOrderData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionOrderData`
        """
        model = AuctionOrderData()
        if include_optional:
            return AuctionOrderData(
                blocks = [
