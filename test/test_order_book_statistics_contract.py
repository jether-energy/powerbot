...
class TestOrderBookStatisticsContract(unittest.TestCase):
    """OrderBookStatisticsContract unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderBookStatisticsContract:
        """Test OrderBookStatisticsContract
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderBookStatisticsContract`
        """
        model = OrderBookStatisticsContract()
        if include_optional:
            return OrderBookStatisticsContract(
                contract_id = '',
                product = '',
                best_bid_price = 1.337,
                best_bid_quantity = 1.337,
                best_ask_price = 1.337,
                ...
                vwap = 1.337,
                depth_values = [
                    powerbot_client.models.order_book_depth_value.OrderBookDepthValue(
                        depth = 1.337, 
                        average_bid = 1.337, 
                        average_ask = 1.337, )
                    ],
    ...
    def testOrderBookStatisticsContract(self):
        """Test OrderBookStatisticsContract"""
