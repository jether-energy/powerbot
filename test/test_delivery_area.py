...
class TestDeliveryArea(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeliveryArea:
        ...
        if include_optional:
            return DeliveryArea(
                eic = '10YDE-VE-------2',
                market_eic = '10Y1001A1001A82H',
                name = '50HzT',
                long_name = '50Hertz Transmission GmbH',
                state = 'ACTI',
                time_zone = 'CET',
                currency = 'EUR',
                products = ["Intraday_Hour_Power","Intraday_Half_Hour_Power","Intraday_Quarter_Hour_Power"],
                product_details = [{"product_name":"XBID_Hour_Power","price_currency":"EUR","quantity_unit":"MW","duration_minutes":60}]
            )
        else:
            return DeliveryArea(
                eic = '10YDE-VE-------2',
