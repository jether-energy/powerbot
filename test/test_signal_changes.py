...
class TestSignalChanges(unittest.TestCase):
    """SignalChanges unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignalChanges:
        """Test SignalChanges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalChanges`
        """
        model = SignalChanges()
        if include_optional:
