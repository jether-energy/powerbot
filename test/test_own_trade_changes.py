...
class TestOwnTradeChanges(unittest.TestCase):
    """OwnTradeChanges unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OwnTradeChanges:
        """Test OwnTradeChanges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OwnTradeChanges`
        """
        model = OwnTradeChanges()
        if include_optional:
            return OwnTradeChanges(
                message_class = '',
