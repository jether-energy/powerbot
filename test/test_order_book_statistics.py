...
class TestOrderBookStatistics(unittest.TestCase):
    """OrderBookStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderBookStatistics:
        """Test OrderBookStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderBookStatistics`
        """
        ...
        if include_optional:
            return OrderBookStatistics(
                ...
                contracts = [
                    powerbot_client.models.order_book_statistics_contract.OrderBookStatisticsContract(
                        contract_id = '', 
                        product = '', 
    ...
    def testOrderBookStatistics(self):
        """Test OrderBookStatistics"""
