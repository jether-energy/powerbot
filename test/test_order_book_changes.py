...
class TestOrderBookChanges(unittest.TestCase):
    """OrderBookChanges unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderBookChanges:
        """Test OrderBookChanges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderBookChanges`
        """
        model = OrderBookChanges()
        if include_optional:
