...
class TestAlgoEvent(unittest.TestCase):
    """AlgoEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgoEvent:
        """Test AlgoEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlgoEvent`
        """
        model = AlgoEvent()
        if include_optional:
            return AlgoEvent(
