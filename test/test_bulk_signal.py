...
class TestBulkSignal(unittest.TestCase):
    """BulkSignal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkSignal:
        """Test BulkSignal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkSignal`
        """
        model = BulkSignal()
        if include_optional:
            return BulkSignal(
