...
class TestSubscriptionEndpoint(unittest.TestCase):
    """SubscriptionEndpoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionEndpoint:
        """Test SubscriptionEndpoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionEndpoint`
        """
        model = SubscriptionEndpoint()
        if include_optional:
    ...
    def testSubscriptionEndpoint(self):
        """Test SubscriptionEndpoint"""
