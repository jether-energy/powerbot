...
class TestUpdatedApiKey(unittest.TestCase):
    """UpdatedApiKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatedApiKey:
        """Test UpdatedApiKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatedApiKey`
        """
        model = UpdatedApiKey()
        if include_optional:
