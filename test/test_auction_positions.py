...
class TestAuctionPositions(unittest.TestCase):
    """AuctionPositions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionPositions:
        """Test AuctionPositions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionPositions`
        """
        model = AuctionPositions()
        if include_optional:
            return AuctionPositions(
                net_pos = 1.337,
                min_net_pos = 1.337,
                max_net_pos = 1.337,
                abs_pos = 1.337,
