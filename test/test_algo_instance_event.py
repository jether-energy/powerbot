...
class TestAlgoInstanceEvent(unittest.TestCase):
    """AlgoInstanceEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgoInstanceEvent:
        """Test AlgoInstanceEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlgoInstanceEvent`
        """
        model = AlgoInstanceEvent()
        if include_optional:
            return AlgoInstanceEvent(
                message_class = '',
                algorithm = powerbot_client.models.algo_details.AlgoDetails(
                    algo_id = '', 
                    algo_name = '', 
                    algo_description = '', 
                    ...
                    image = '', 
                    instances = [
                        powerbot_client.models.algo_instance.AlgoInstance(
                            instance_id = '', 
                            exchange = '', 
                            tenant_id = '', 
                            portfolio_ids = [
                            ...
                            parameters = powerbot_client.models.parameters.parameters(), 
                            status = 'IDLE', 
                            ...
                            resources = powerbot_client.models.resources.Resources(
                                requests = powerbot_client.models.requests.Requests(
                                    cpu = '0.5', 
                                    memory = '256Mi', ), ), 
                            heartbeat = powerbot_client.models.algo_heartbeat.AlgoHeartbeat(
                                status_text = '', ), )
                        ], 
    ...
    def testAlgoInstanceEvent(self):
        """Test AlgoInstanceEvent"""
