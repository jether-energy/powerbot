...
class TestOrderBookRevision(unittest.TestCase):
    """OrderBookRevision unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderBookRevision:
        """Test OrderBookRevision
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderBookRevision`
        """
        model = OrderBookRevision()
        if include_optional:
            return OrderBookRevision(
    ...
    def testOrderBookRevision(self):
        """Test OrderBookRevision"""
