...
class TestApiKeyPortfolioUpdate(unittest.TestCase):
    """ApiKeyPortfolioUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKeyPortfolioUpdate:
        """Test ApiKeyPortfolioUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKeyPortfolioUpdate`
        """
        model = ApiKeyPortfolioUpdate()
        if include_optional:
            return ApiKeyPortfolioUpdate(
                portfolio_ids = ["P1","P2"],
    ...
    def testApiKeyPortfolioUpdate(self):
        """Test ApiKeyPortfolioUpdate"""
