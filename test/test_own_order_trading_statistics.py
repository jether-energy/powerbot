...
class TestOwnOrderTradingStatistics(unittest.TestCase):
    """OwnOrderTradingStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OwnOrderTradingStatistics:
        """Test OwnOrderTradingStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OwnOrderTradingStatistics`
        """
        model = OwnOrderTradingStatistics()
        if include_optional:
            return OwnOrderTradingStatistics(
                time_series_from = '2024-01-01T01:00Z',
                time_series_to = '2024-01-01T01:03Z',
                time_series_bucket_size_seconds = 60,
                order_revision_series = [0,415,311],
                trade_volume_series = [0,0.1,2.1],
                order_revisions_total = 726,
                trade_volume_total = 2.2
            )
        else:
            return OwnOrderTradingStatistics(
                time_series_from = '2024-01-01T01:00Z',
    ...
    def testOwnOrderTradingStatistics(self):
        """Test OwnOrderTradingStatistics"""
