...
class TestInstanceHeartbeatStatus(unittest.TestCase):
    """InstanceHeartbeatStatus unit test stubs"""
    ...
    def testInstanceHeartbeatStatus(self):
        """Test InstanceHeartbeatStatus"""
        # inst = InstanceHeartbeatStatus()
