...
class TestChangedCredentials(unittest.TestCase):
    """ChangedCredentials unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChangedCredentials:
        """Test ChangedCredentials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChangedCredentials`
        """
        model = ChangedCredentials()
        if include_optional:
    ...
    def testChangedCredentials(self):
        """Test ChangedCredentials"""
