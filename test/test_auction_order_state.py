...
class TestAuctionOrderState(unittest.TestCase):
    """AuctionOrderState unit test stubs"""
    ...
    def testAuctionOrderState(self):
        """Test AuctionOrderState"""
        # inst = AuctionOrderState()
