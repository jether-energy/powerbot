...
class TestPortfolioStatus(unittest.TestCase):
    """PortfolioStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortfolioStatus:
        """Test PortfolioStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortfolioStatus`
        """
        model = PortfolioStatus()
        if include_optional:
            return PortfolioStatus(
                rolling_window_counts = [
                    powerbot_client.models.rolling_window_count.RollingWindowCount(
