...
class TestAuctionResultEvent(unittest.TestCase):
    """AuctionResultEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionResultEvent:
        """Test AuctionResultEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionResultEvent`
        """
        model = AuctionResultEvent()
        if include_optional:
    ...
    def testAuctionResultEvent(self):
        """Test AuctionResultEvent"""
