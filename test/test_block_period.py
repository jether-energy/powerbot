...
class TestBlockPeriod(unittest.TestCase):
    """BlockPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlockPeriod:
        """Test BlockPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlockPeriod`
        """
        model = BlockPeriod()
        if include_optional:
            return BlockPeriod(
