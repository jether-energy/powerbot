...
class TestReportApi(unittest.TestCase):
    ...
    def test_get_report_csv_for_period(self) -> None:
        """Test case for get_report_csv_for_period

        Create CSV trading report
        """
        pass

    def test_get_report_for_period(self) -> None:
        """Test case for get_report_for_period

        Create JSON trading report
        """
        pass

    def test_get_schedule_xml(self) -> None:
        """Test case for get_schedule_xml
