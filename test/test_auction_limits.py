...
class TestAuctionLimits(unittest.TestCase):
    """AuctionLimits unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionLimits:
        """Test AuctionLimits
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionLimits`
        """
        model = AuctionLimits()
        if include_optional:
            return AuctionLimits(
                exchange = 'epex',
                delivery_area = '',
