    ...
    def make_instance(self, include_optional) -> Auction:
        ...
        if include_optional:
            return Auction(
                ...
                contracts = [
                    powerbot_client.models.auction_contract.AuctionContract(
                        contract_id = '', 
                        delivery_start = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        delivery_end = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        delivery_areas = [
                ...
                order_entry_start = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                order_entry_end = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                state = 'ANNOUNCED'
            )
        else:
            return Auction(
