...
class TestOrderEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrderEntry:
        """Test OrderEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderEntry`
        """
        model = OrderEntry()
        if include_optional:
            return OrderEntry(
                ...
                txt = 'myOrderMarker',
                ppd = 1.337,
                dlvry_start = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                dlvry_end = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
