...
class TestAuctionContractResult(unittest.TestCase):
    """AuctionContractResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionContractResult:
        """Test AuctionContractResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionContractResult`
        """
        model = AuctionContractResult()
        if include_optional:
            return AuctionContractResult(
                contract = powerbot_client.models.auction_contract.AuctionContract(
                    contract_id = '', 
                ...
                delivery_areas = [
                    powerbot_client.models.auction_area_result.AuctionAreaResult(
                        delivery_area = '', 
                        clearing_prices = [
                            powerbot_client.models.currency_price.CurrencyPrice(
                                price = 1.337, 
                                currency = '', )
                            ], 
    ...
    def testAuctionContractResult(self):
        """Test AuctionContractResult"""
