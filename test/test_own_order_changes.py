...
class TestOwnOrderChanges(unittest.TestCase):
    """OwnOrderChanges unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OwnOrderChanges:
        """Test OwnOrderChanges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OwnOrderChanges`
        """
        model = OwnOrderChanges()
        if include_optional:
            return OwnOrderChanges(
                message_class = '',
