...
class TestValidityRestriction(unittest.TestCase):
    """ValidityRestriction unit test stubs"""
    ...
    def testValidityRestriction(self):
        """Test ValidityRestriction"""
        # inst = ValidityRestriction()
