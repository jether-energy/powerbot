...
class TestAlgoInstance(unittest.TestCase):
    """AlgoInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgoInstance:
        """Test AlgoInstance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlgoInstance`
        """
        model = AlgoInstance()
        if include_optional:
            return AlgoInstance(
