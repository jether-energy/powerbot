...
class TestAuctionTrade(unittest.TestCase):
    """AuctionTrade unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionTrade:
        """Test AuctionTrade
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionTrade`
        """
        model = AuctionTrade()
        if include_optional:
            return AuctionTrade(
