...
class TestUpdatedTenant(unittest.TestCase):
    """UpdatedTenant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatedTenant:
        """Test UpdatedTenant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatedTenant`
        """
        model = UpdatedTenant()
        if include_optional:
