...
class TestSignalSourceDurations(unittest.TestCase):
    """SignalSourceDurations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignalSourceDurations:
        """Test SignalSourceDurations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalSourceDurations`
        """
        model = SignalSourceDurations()
        if include_optional:
            return SignalSourceDurations(
                source = '',
                durations = [
                    56
                    ]
    ...
    def testSignalSourceDurations(self):
        """Test SignalSourceDurations"""
