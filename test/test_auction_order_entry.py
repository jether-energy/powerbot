...
class TestAuctionOrderEntry(unittest.TestCase):
    """AuctionOrderEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionOrderEntry:
        """Test AuctionOrderEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionOrderEntry`
        """
        model = AuctionOrderEntry()
        if include_optional:
            return AuctionOrderEntry(
                auction_id = '',
                delivery_area = '',
                portfolio_id = '',
                order_data = powerbot_client.models.auction_order_data.AuctionOrderData(
                    blocks = [
                        powerbot_client.models.block.Block(
                            id = '', 
                            price = 1.337, 
                            minimum_acceptance_ratio = 1.337, 
                            comment = '', 
                            type = 'REGULAR', 
                            type_value = '', 
                            state = 'ACCEPTED', 
                            periods = [
                                powerbot_client.models.block_period.BlockPeriod(
                                    contract_id = '', 
                                    quantity = 1.337, )
                                ], )
                        ], 
                    curves = [
                        powerbot_client.models.curve.Curve(
                            contract_id = '', 
                            comment = 'Forecast based Order', 
                            curve_points = [
                                powerbot_client.models.curve_point.CurvePoint(
                                    price = -500.0, 
                                    quantity = 10.0, )
                                ], )
                        ], )
    ...
    def testAuctionOrderEntry(self):
        """Test AuctionOrderEntry"""
