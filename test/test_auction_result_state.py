...
class TestAuctionResultState(unittest.TestCase):
    """AuctionResultState unit test stubs"""
    ...
    def testAuctionResultState(self):
        """Test AuctionResultState"""
        # inst = AuctionResultState()
