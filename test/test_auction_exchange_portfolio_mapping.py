...
class TestAuctionExchangePortfolioMapping(unittest.TestCase):
    """AuctionExchangePortfolioMapping unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionExchangePortfolioMapping:
        """Test AuctionExchangePortfolioMapping
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionExchangePortfolioMapping`
        """
        model = AuctionExchangePortfolioMapping()
        if include_optional:
            return AuctionExchangePortfolioMapping(
                powerbot_portfolio_id = '',
                exchange_portfolio_name = '',
                currency_mapping = [
                    powerbot_client.models.delivery_area_currency_mapping.DeliveryAreaCurrencyMapping(
                        delivery_area = '', 
                        currency = '', )
                    ],
                delivery_areas = [
    ...
    def testAuctionExchangePortfolioMapping(self):
        """Test AuctionExchangePortfolioMapping"""
