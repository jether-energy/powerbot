...
class TestContractStatistics(unittest.TestCase):
    """ContractStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContractStatistics:
        """Test ContractStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContractStatistics`
        """
        model = ContractStatistics()
        if include_optional:
    ...
    def testContractStatistics(self):
        """Test ContractStatistics"""
