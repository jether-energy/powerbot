...
class TestSignalTimeSlice(unittest.TestCase):
    """SignalTimeSlice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignalTimeSlice:
        """Test SignalTimeSlice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalTimeSlice`
        """
        model = SignalTimeSlice()
        if include_optional:
            return SignalTimeSlice(
                active = True,
                historic = True,
                deleted = True,
