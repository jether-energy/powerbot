...
class TestAuctionConstraints(unittest.TestCase):
    """AuctionConstraints unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionConstraints:
        """Test AuctionConstraints
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionConstraints`
        """
        model = AuctionConstraints()
        if include_optional:
            return AuctionConstraints(
                min_price = 1.337,
                max_price = 1.337,
                price_tick = 1.337
            )
    ...
    def testAuctionConstraints(self):
        """Test AuctionConstraints"""
