...
class TestHistoricDataApi(unittest.TestCase):
    """HistoricDataApi unit test stubs"""

    def setUp(self) -> None:
        self.api = HistoricDataApi()

    def tearDown(self) -> None:
        pass

    def test_get_historic_orders(self) -> None:
        """Test case for get_historic_orders

        Get order book revisions for historic contracts
        """
        pass

    def test_get_historic_trades(self) -> None:
        """Test case for get_historic_trades
