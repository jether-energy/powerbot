...
class TestUpdateAlgoSetup(unittest.TestCase):
    """UpdateAlgoSetup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateAlgoSetup:
        """Test UpdateAlgoSetup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateAlgoSetup`
        """
        model = UpdateAlgoSetup()
        if include_optional:
            return UpdateAlgoSetup(
                name = '',
                description = '',
