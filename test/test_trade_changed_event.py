...
class TestTradeChangedEvent(unittest.TestCase):
    """TradeChangedEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TradeChangedEvent:
        """Test TradeChangedEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TradeChangedEvent`
        """
        model = TradeChangedEvent()
        if include_optional:
            return TradeChangedEvent(
                message_class = '',
                delivery_area = '',
                sell_portfolio_id = '',
                buy_portfolio_id = '',
    ...
    def testTradeChangedEvent(self):
        """Test TradeChangedEvent"""
