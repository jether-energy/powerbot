...
class TestSignalEntryResult(unittest.TestCase):
    """SignalEntryResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignalEntryResult:
        """Test SignalEntryResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalEntryResult`
        """
        model = SignalEntryResult()
        if include_optional:
    ...
    def testSignalEntryResult(self):
        """Test SignalEntryResult"""
