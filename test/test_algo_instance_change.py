...
class TestAlgoInstanceChange(unittest.TestCase):
    """AlgoInstanceChange unit test stubs"""
    ...
    def testAlgoInstanceChange(self):
        """Test AlgoInstanceChange"""
        # inst = AlgoInstanceChange()
