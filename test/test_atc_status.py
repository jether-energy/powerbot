...
class TestAtcStatus(unittest.TestCase):
    """AtcStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AtcStatus:
        """Test AtcStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AtcStatus`
        """
        model = AtcStatus()
        if include_optional:
            return AtcStatus(
