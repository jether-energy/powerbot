...
class TestAlgoSetup(unittest.TestCase):
    """AlgoSetup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgoSetup:
        """Test AlgoSetup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlgoSetup`
        """
        model = AlgoSetup()
        if include_optional:
            return AlgoSetup(
                ...
                name = '',
                description = '',
                require_heartbeat_every_seconds = 1,
