...
class TestAuctionConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AuctionConfig:
        """Test AuctionConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionConfig`
        """
        model = AuctionConfig()
        if include_optional:
            return AuctionConfig(
                portfolios = [
                    powerbot_client.models.auction_exchange_portfolio.AuctionExchangePortfolio(
