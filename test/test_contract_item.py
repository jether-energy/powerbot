...
class TestContractItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ContractItem:
        """Test ContractItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContractItem`
        """
        model = ContractItem()
        if include_optional:
            return ContractItem(
                ...
                delivery_area_states = [
                    powerbot_client.models.delivery_area_state.DeliveryAreaState(
