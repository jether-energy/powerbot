...
class TestSignalsApi(unittest.TestCase):
    ...
    def test_delete_signals(self) -> None:
        """Test case for delete_signals

        Delete signals
        """
        pass

    def test_delete_time_slice(self) -> None:
        """Test case for delete_time_slice

        Delete a time slice
        """
        pass

    def test_delete_trading_signal(self) -> None:
        """Test case for delete_trading_signal

        Delete a trading signal
        """
        pass

    def test_find_trading_signals(self) -> None:
        """Test case for find_trading_signals
    ...
    def test_get_signals_history(self) -> None:
        """Test case for get_signals_history

        List signals history
        """
        pass

    def test_get_sources_durations(self) -> None:
        """Test case for get_sources_durations

        Get sources and durations
        """
        pass

    def test_save_trading_signals(self) -> None:
        """Test case for save_trading_signals

        Save trading signals
        """
        pass

    def test_update_signals(self) -> None:
        """Test case for update_signals
