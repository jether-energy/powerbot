...
class TestAlgoCommand(unittest.TestCase):
    """AlgoCommand unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgoCommand:
        """Test AlgoCommand
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlgoCommand`
        """
        model = AlgoCommand()
        if include_optional:
            return AlgoCommand(
