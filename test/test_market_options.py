...
class TestMarketOptions(unittest.TestCase):
    """MarketOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketOptions:
        """Test MarketOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketOptions`
        """
        model = MarketOptions()
        if include_optional:
