...
class TestLogEntryAdded(unittest.TestCase):
    """LogEntryAdded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogEntryAdded:
        """Test LogEntryAdded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogEntryAdded`
        """
        model = LogEntryAdded()
        if include_optional:
            return LogEntryAdded(
                ...
                log_entry = powerbot_client.models.log_entry.LogEntry(
                    id = '', 
                    received = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    text = 'Trading algorithm is starting...', 
