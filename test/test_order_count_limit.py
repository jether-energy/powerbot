...
class TestOrderCountLimit(unittest.TestCase):
    """OrderCountLimit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderCountLimit:
        """Test OrderCountLimit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderCountLimit`
        """
        model = OrderCountLimit()
        if include_optional:
