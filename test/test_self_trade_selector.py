...
class TestSelfTradeSelector(unittest.TestCase):
    """SelfTradeSelector unit test stubs"""
    ...
    def testSelfTradeSelector(self):
        """Test SelfTradeSelector"""
        # inst = SelfTradeSelector()
