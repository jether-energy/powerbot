...
class TestPositionSourceValue(unittest.TestCase):
    """PositionSourceValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PositionSourceValue:
        """Test PositionSourceValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PositionSourceValue`
        """
        model = PositionSourceValue()
        if include_optional:
            return PositionSourceValue(
                duration = 56,
    ...
    def testPositionSourceValue(self):
        """Test PositionSourceValue"""
