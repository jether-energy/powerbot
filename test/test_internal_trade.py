...
class TestInternalTrade(unittest.TestCase):
    """InternalTrade unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InternalTrade:
        """Test InternalTrade
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InternalTrade`
        """
        model = InternalTrade()
        if include_optional:
