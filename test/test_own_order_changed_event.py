...
class TestOwnOrderChangedEvent(unittest.TestCase):
    """OwnOrderChangedEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OwnOrderChangedEvent:
        """Test OwnOrderChangedEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OwnOrderChangedEvent`
        """
        model = OwnOrderChangedEvent()
        if include_optional:
            return OwnOrderChangedEvent(
                message_class = '',
                portfolio_id = '',
                delivery_area = '',
    ...
    def testOwnOrderChangedEvent(self):
        """Test OwnOrderChangedEvent"""
