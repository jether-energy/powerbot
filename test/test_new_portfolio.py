...
class TestNewPortfolio(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NewPortfolio:
        """Test NewPortfolio
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewPortfolio`
        """
        model = NewPortfolio()
        if include_optional:
            return NewPortfolio(
