...
class TestTenantsApi(unittest.TestCase):
    ...
    def test_get_tenant_risk_management(self) -> None:
        """Test case for get_tenant_risk_management
    ...
    def test_update_tenant_risk_management_settings(self) -> None:
        """Test case for update_tenant_risk_management_settings
