...
class TestAuctionContract(unittest.TestCase):
    """AuctionContract unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionContract:
        """Test AuctionContract
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionContract`
        """
