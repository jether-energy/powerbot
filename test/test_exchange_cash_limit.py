...
class TestExchangeCashLimit(unittest.TestCase):
    """ExchangeCashLimit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExchangeCashLimit:
        """Test ExchangeCashLimit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExchangeCashLimit`
        """
        model = ExchangeCashLimit()
        if include_optional:
            return ExchangeCashLimit(
                currency = 'EUR',
    ...
    def testExchangeCashLimit(self):
        """Test ExchangeCashLimit"""
