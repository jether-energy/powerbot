...
class TestDeliveryAreaCurrencyMapping(unittest.TestCase):
    """DeliveryAreaCurrencyMapping unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliveryAreaCurrencyMapping:
        """Test DeliveryAreaCurrencyMapping
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliveryAreaCurrencyMapping`
        """
        model = DeliveryAreaCurrencyMapping()
        if include_optional:
            return DeliveryAreaCurrencyMapping(
                delivery_area = '',
                currency = ''
            )
        else:
    ...
    def testDeliveryAreaCurrencyMapping(self):
        """Test DeliveryAreaCurrencyMapping"""
