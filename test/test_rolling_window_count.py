...
class TestRollingWindowCount(unittest.TestCase):
    """RollingWindowCount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RollingWindowCount:
        """Test RollingWindowCount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RollingWindowCount`
        """
        model = RollingWindowCount()
        if include_optional:
            return RollingWindowCount(
                rolling_window_seconds = 56,
                current_order_count = 56
            )
        else:
            return RollingWindowCount(
        )
    ...
    def testRollingWindowCount(self):
        """Test RollingWindowCount"""
