...
class TestMarketMode(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MarketMode:
        """Test MarketMode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketMode`
        """
        model = MarketMode()
        if include_optional:
            return MarketMode(
