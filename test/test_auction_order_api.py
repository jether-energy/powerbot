...
class TestAuctionOrderApi(unittest.TestCase):
    """AuctionOrderApi unit test stubs"""

    def setUp(self) -> None:
        self.api = AuctionOrderApi()
    ...
    def test_get_auction_order_history(self) -> None:
        """Test case for get_auction_order_history

        Get Order History
        """
        pass

    def test_get_auction_orders(self) -> None:
        """Test case for get_auction_orders
