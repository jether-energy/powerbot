...
class TestAuctionExchange(unittest.TestCase):
    """AuctionExchange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionExchange:
        """Test AuctionExchange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionExchange`
        """
        model = AuctionExchange()
        if include_optional:
            return AuctionExchange(
                exchange = 'epex',
                status = 'LOGGED_IN',
                logged_in_username = ''
            )
