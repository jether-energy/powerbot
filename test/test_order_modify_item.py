...
class TestOrderModifyItem(unittest.TestCase):
    """OrderModifyItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderModifyItem:
        """Test OrderModifyItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderModifyItem`
        """
        model = OrderModifyItem()
        if include_optional:
            return OrderModifyItem(
                order_id = '',
                revision_no = 56,
                changes = powerbot_client.models.order_modify.OrderModify(
                    action = 'ACTI', 
                    validity_res = 'GFS', 
                    ...
                    price = 1.337, 
                    ppd = 1.337, 
                    expected_net_pos = 1.337, 
                    expected_min_net_pos = 1.337, 
                    expected_max_net_pos = 1.337, 
                    expected_abs_pos = 1.337, 
                    expected_sell_abs_pos = 1.337, 
                    expected_buy_abs_pos = 1.337, 
                    location = '', )
            )
        else:
            return OrderModifyItem(
