...
class TestSignalEntryResponse(unittest.TestCase):
    """SignalEntryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignalEntryResponse:
        """Test SignalEntryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalEntryResponse`
        """
        model = SignalEntryResponse()
        if include_optional:
            return SignalEntryResponse(
                results = [
                    powerbot_client.models.signal_entry_result.SignalEntryResult(
                        source = '', 
                        delivery_area = '', 
                        portfolio_id = '', 
    ...
    def testSignalEntryResponse(self):
        """Test SignalEntryResponse"""
