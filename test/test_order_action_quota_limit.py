...
class TestOrderActionQuotaLimit(unittest.TestCase):
    """OrderActionQuotaLimit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderActionQuotaLimit:
        """Test OrderActionQuotaLimit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderActionQuotaLimit`
        """
        model = OrderActionQuotaLimit()
        if include_optional:
            return OrderActionQuotaLimit(
                exchange = 'epex',
                order_quota_limit = 0
            )
        else:
    ...
    def testOrderActionQuotaLimit(self):
        """Test OrderActionQuotaLimit"""
