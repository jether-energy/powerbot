...
class TestSignalEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SignalEntry:
        """Test SignalEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalEntry`
        """
        model = SignalEntry()
        if include_optional:
            return SignalEntry(
                ...
                portfolio_id = 'P1',
                delivery_start = '2023-01-01T09:15Z',
                delivery_end = '2023-01-01T09:30Z',
                time_slices = [
                    {"minutes_to_delivery":100,"locked":false,"parameters":{"value1":"value1","value2":"value2","position_long":10.0,"position_short":0.0}}
                    ]
            )
        else:
            return SignalEntry(
