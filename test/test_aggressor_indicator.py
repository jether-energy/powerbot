...
class TestAggressorIndicator(unittest.TestCase):
    """AggressorIndicator unit test stubs"""
    ...
    def testAggressorIndicator(self):
        """Test AggressorIndicator"""
        # inst = AggressorIndicator()
