...
class TestAlgoInstanceParameters(unittest.TestCase):
    """AlgoInstanceParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgoInstanceParameters:
        """Test AlgoInstanceParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlgoInstanceParameters`
        """
        model = AlgoInstanceParameters()
        if include_optional:
            return AlgoInstanceParameters(
                instance_id = '2',
                tenant_id = '',
                portfolio_ids = [
                    ''
    ...
    def testAlgoInstanceParameters(self):
        """Test AlgoInstanceParameters"""
