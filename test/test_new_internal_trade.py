...
class TestNewInternalTrade(unittest.TestCase):
    """NewInternalTrade unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewInternalTrade:
        """Test NewInternalTrade
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewInternalTrade`
        """
        model = NewInternalTrade()
        if include_optional:
