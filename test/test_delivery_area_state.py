...
class TestDeliveryAreaState(unittest.TestCase):
    """DeliveryAreaState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliveryAreaState:
        """Test DeliveryAreaState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliveryAreaState`
        """
        model = DeliveryAreaState()
        if include_optional:
            return DeliveryAreaState(
                delivery_area = '10YBE----------2',
                state = 'ACTIVE',
                trading_start = '2022-08-30T11:00Z',
                trading_end = '2022-08-31T10:30Z'
            )
        else:
            return DeliveryAreaState(
        )
    ...
    def testDeliveryAreaState(self):
        """Test DeliveryAreaState"""
