...
class TestUpdatedPortfolio(unittest.TestCase):
    """UpdatedPortfolio unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatedPortfolio:
        """Test UpdatedPortfolio
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatedPortfolio`
        """
        model = UpdatedPortfolio()
        if include_optional:
