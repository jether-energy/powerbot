...
class TestAuctionSettings(unittest.TestCase):
    """AuctionSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionSettings:
        """Test AuctionSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionSettings`
        """
