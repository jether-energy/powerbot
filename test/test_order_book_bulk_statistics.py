...
class TestOrderBookBulkStatistics(unittest.TestCase):
    """OrderBookBulkStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderBookBulkStatistics:
        """Test OrderBookBulkStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderBookBulkStatistics`
        """
        model = OrderBookBulkStatistics()
        if include_optional:
            return OrderBookBulkStatistics(
                api_timestamp = '2023-01-01T09:15Z',
                delivery_area = '10YDE-RWENET---I',
                statistics = [{"delivery_start":"2023-01-01T09:15:00Z","delivery_end":"2023-01-01T09:30:00Z","contracts":[{"contract_id":"123456","product":"Intraday_Quarter_Hour_Power","best_bid_price":50,"best_bid_quantity":1.9,"best_ask_price":170.3,"best_ask_quantity":4.7,"last_price":165.2,"last_quantity":0.8,"total_quantity":45.6,"high":500,"low":3,"vwap":130.22,"depth_values":[{"depth":5,"average_bid":17.04,"average_ask":69.34},{"depth":10,"average_bid":8.52,"average_ask":34.67}]}]}]
            )
        else:
            return OrderBookBulkStatistics(
        )
    ...
    def testOrderBookBulkStatistics(self):
        """Test OrderBookBulkStatistics"""
