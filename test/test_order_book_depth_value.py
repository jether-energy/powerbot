...
class TestOrderBookDepthValue(unittest.TestCase):
    """OrderBookDepthValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderBookDepthValue:
        """Test OrderBookDepthValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderBookDepthValue`
        """
        model = OrderBookDepthValue()
        if include_optional:
            return OrderBookDepthValue(
                depth = 1.337,
                average_bid = 1.337,
                average_ask = 1.337
            )
    ...
    def testOrderBookDepthValue(self):
        """Test OrderBookDepthValue"""
