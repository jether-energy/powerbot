...
class TestSignalSearchItem(unittest.TestCase):
    """SignalSearchItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignalSearchItem:
        """Test SignalSearchItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalSearchItem`
        """
        model = SignalSearchItem()
        if include_optional:
            return SignalSearchItem(
                source = 'ETRMSystem',
                delivery_area = '',
                portfolio_id = '',
