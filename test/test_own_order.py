...
class TestOwnOrder(unittest.TestCase):
    """OwnOrder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OwnOrder:
        """Test OwnOrder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OwnOrder`
        """
        model = OwnOrder()
        if include_optional:
            return OwnOrder(
