...
class TestAlgoHeartbeat(unittest.TestCase):
    """AlgoHeartbeat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgoHeartbeat:
        """Test AlgoHeartbeat
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlgoHeartbeat`
        """
        model = AlgoHeartbeat()
        if include_optional:
            return AlgoHeartbeat(
                status = 'OK',
                status_text = ''
            )
        else:
