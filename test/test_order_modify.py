...
class TestOrderModify(unittest.TestCase):
    """OrderModify unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderModify:
        """Test OrderModify
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderModify`
        """
        model = OrderModify()
        if include_optional:
            return OrderModify(
