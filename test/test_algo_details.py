...
class TestAlgoDetails(unittest.TestCase):
    """AlgoDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlgoDetails:
        """Test AlgoDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlgoDetails`
        """
        model = AlgoDetails()
        if include_optional:
            return AlgoDetails(
