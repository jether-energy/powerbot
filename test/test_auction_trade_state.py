...
class TestAuctionTradeState(unittest.TestCase):
    """AuctionTradeState unit test stubs"""
    ...
    def testAuctionTradeState(self):
        """Test AuctionTradeState"""
        # inst = AuctionTradeState()
