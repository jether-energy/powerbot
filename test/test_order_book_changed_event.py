...
class TestOrderBookChangedEvent(unittest.TestCase):
    """OrderBookChangedEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderBookChangedEvent:
        """Test OrderBookChangedEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderBookChangedEvent`
        """
        model = OrderBookChangedEvent()
        if include_optional:
            return OrderBookChangedEvent(
                message_class = '',
                portfolio_id = '',
    ...
    def testOrderBookChangedEvent(self):
        """Test OrderBookChangedEvent"""
