...
class TestPublicOrderRevision(unittest.TestCase):
    """PublicOrderRevision unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicOrderRevision:
        """Test PublicOrderRevision
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicOrderRevision`
        """
        model = PublicOrderRevision()
        if include_optional:
            return PublicOrderRevision(
                order_id = '',
                price = 1.337,
                quantity = 1.337,
    ...
    def testPublicOrderRevision(self):
        """Test PublicOrderRevision"""
