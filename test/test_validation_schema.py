...
class TestValidationSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ValidationSchema:
        """Test ValidationSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidationSchema`
        """
        ...
        if include_optional:
            return ValidationSchema(
                ...
                name = 'pos_opener',
                version = '1.0',
                description = 'An example description for a schema.',
                parameters = None
            )
        else:
            return ValidationSchema(
