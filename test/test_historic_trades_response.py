...
class TestHistoricTradesResponse(unittest.TestCase):
    """HistoricTradesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HistoricTradesResponse:
        """Test HistoricTradesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HistoricTradesResponse`
        """
        model = HistoricTradesResponse()
        if include_optional:
            return HistoricTradesResponse(
                next_page_token = '',
                trades = [
    ...
    def testHistoricTradesResponse(self):
        """Test HistoricTradesResponse"""
