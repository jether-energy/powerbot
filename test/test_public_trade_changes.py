...
class TestPublicTradeChanges(unittest.TestCase):
    """PublicTradeChanges unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicTradeChanges:
        """Test PublicTradeChanges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicTradeChanges`
        """
        model = PublicTradeChanges()
        if include_optional:
            return PublicTradeChanges(
                message_class = '',
    ...
    def testPublicTradeChanges(self):
        """Test PublicTradeChanges"""
