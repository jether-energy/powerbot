...
class TestAuctionResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AuctionResult:
        """Test AuctionResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionResult`
        """
        model = AuctionResult()
        if include_optional:
            return AuctionResult(
                ...
                state = 'NOT_AVAILABLE',
                contract_results = [
                    powerbot_client.models.auction_contract_result.AuctionContractResult(
