...
class TestAuctionAreaResultTrade(unittest.TestCase):
    """AuctionAreaResultTrade unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionAreaResultTrade:
        """Test AuctionAreaResultTrade
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionAreaResultTrade`
        """
        model = AuctionAreaResultTrade()
        if include_optional:
            return AuctionAreaResultTrade(
                id = '',
                price = 1.337,
                quantity = 1.337,
                state = 'ACTI'
    ...
    def testAuctionAreaResultTrade(self):
        """Test AuctionAreaResultTrade"""
