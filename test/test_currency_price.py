...
class TestCurrencyPrice(unittest.TestCase):
    """CurrencyPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrencyPrice:
        """Test CurrencyPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyPrice`
        """
        model = CurrencyPrice()
        if include_optional:
