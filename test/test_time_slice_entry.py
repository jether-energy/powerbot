...
class TestTimeSliceEntry(unittest.TestCase):
    """TimeSliceEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeSliceEntry:
        """Test TimeSliceEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeSliceEntry`
        """
        model = TimeSliceEntry()
        if include_optional:
            return TimeSliceEntry(
                minutes_to_delivery = 2880,
                locked = True,
                parameters = {"value1":"value1","value2":"value2","position_long":10.0,"position_short":0.0}
            )
        else:
            return TimeSliceEntry(
                minutes_to_delivery = 2880,
