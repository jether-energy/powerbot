...
class TestBulkContractStatistics(unittest.TestCase):
    """BulkContractStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkContractStatistics:
        """Test BulkContractStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkContractStatistics`
        """
        model = BulkContractStatistics()
        if include_optional:
            return BulkContractStatistics(
                statistics = [
                    powerbot_client.models.contract_statistics.ContractStatistics(
    ...
    def testBulkContractStatistics(self):
        """Test BulkContractStatistics"""
