...
class TestOrderExecutionRestriction(unittest.TestCase):
    """OrderExecutionRestriction unit test stubs"""
    ...
    def testOrderExecutionRestriction(self):
        """Test OrderExecutionRestriction"""
        # inst = OrderExecutionRestriction()
