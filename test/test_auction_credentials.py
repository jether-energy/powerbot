...
class TestAuctionCredentials(unittest.TestCase):
    """AuctionCredentials unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuctionCredentials:
        """Test AuctionCredentials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuctionCredentials`
        """
        model = AuctionCredentials()
        if include_optional:
            return AuctionCredentials(
                username = '',
                password = '',
                certificate_bundle = 'YQ==',
    ...
    def testAuctionCredentials(self):
        """Test AuctionCredentials"""
